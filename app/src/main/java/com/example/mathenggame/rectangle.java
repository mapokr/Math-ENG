...
public class rectangle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        changeA = findViewById(R.id.obw_rectangle);
        changeObw = findViewById(R.id.obw_w_rec);
        changeP1 = findViewById(R.id.pw_rec);
        change_color();
    }
    public void change_color(){
        ...
        obw.setSpan(red_collor_2,36,39, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        obw.setSpan(red_collor_3,59,60, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        obw_w.setSpan(red_collor_3,0,13, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        p1_w.setSpan(red_collor,0,9, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
