...
public class kol extends AppCompatActivity {
    ...
    public void change_color(){
        ...
        obw.setSpan(red_collor,0,3, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        obw_w.setSpan(red_collor_3,0,6, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);

        p1_w.setSpan(red_collor,0,10, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
